...
<html>
<head>
<title>GIKOMBA MARKET PLACE :: SEARCH RESULTS</title>
...
<table width="56%" align="center" class="mainbody">
  ...
  <tr> 
    ...
    <td valign="top"><div align="center"> 
        <p align="center">SEARCH RESULTS<br>
          <br>
          <br>
          <?php 
...
$query = "SELECT id, cat_title, cat_desc FROM store_categories WHERE
cat_title='$category'";
...
echo "<TABLE align=center CLASS=tabledesign><TR><TD>$row->id $row->cat_title $row->cat_desc<br /></TD></TR></TABLE>";
} else {
echo "No results found.<br><a href=index.php>back</a>";
}
}		?>
          <br>
        </p>
