...
function validate()
{
 ...
 if( firstname.value == "" )
 {
  error = " Kindly Fill in your first name. ";
...
var lastname = document.getElementById( "lastname" );
 if( lastname.value == "" )
 {
  error = " You Have To fill in Your Last Name. ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
...
var address = document.getElementById( "address" );
 if( address.value == "" )
 {
  error = " You Have To key in your address. ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
...
var telephone = document.getElementById( "telephone" );
 ...
 {
  error = " You Have To key in a Valid Email Address. ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
 ...
 if( city.value == "" )
 {
  error = " You Have To Select a City. ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
...
var country = document.getElementById( "country" );
 ...
 if( username.value == "" )
 {
  error = " You Have To key in Your Username. ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
 ...
 var confirm_password = document.getElementById( "confrim_password" );
 if( confirm_password.value == "" || confirm_password.value == password.value   )
 {
  error = " Password Do not Match, retry . ";
  document.getElementById( "error_para" ).innerHTML = error;
  return false;
 }
...
<table width="57%" align="center" class="mainbody">
  ...
  <tr> 
    <td height="149" colspan="2" valign="top"><div align="center">New to this? 
        Sign up for an account free of charge and receive the latest products 
        from our catalogs.</div>
      <form name="form1" method="post"  action="datavalid2" onsubmit="return validate();">
        <table width="47%" align="center" class="tabledesign">
          <tr> 
            <td colspan="2" valign="top"><div align="center">USER REGISTRATION 
                DETAILS </div></td>
          </tr>
          <tr> 
            <td valign="top">First name:</td>
            <td valign="top"><input name="firstname" type="text" id="firstname" size="30"> 
            </td>
          </tr>
          <tr> 
            <td valign="top">last name:</td>
            <td valign="top"><input name="lastname" type="text" id="lastname" size="30"></td>
          </tr>
          <tr> 
            <td valign="top">Physical address</td>
            <td valign="top"><input name="address" type="text" id="address" size="30"></td>
          </tr>
          <tr> 
            <td valign="top">telephone/Mobile number: </td>
            <td valign="top"><input name="telephone" type="text" id="telephone" size="30"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td valign="top"><input name="city" type="text" id="city" size="30"></td>
          </tr>
          <tr> 
            <td valign="top">Country:</td>
            <td valign="top"><select name="country" size="1">
                <option value="Choose Country" selected="selected">- Choose Country 
                -</option>
                ...
                <option value="Viet Nam, Socialist Republic of">Viet Nam, Socialist 
                Republic of</option>
          ...
          <tr> 
            <td width="50%" valign="top">Username:</td>
            <td width="50%" valign="top"><input name="username" type="text" id="username" size="30"></td>
          </tr>
          <tr> 
            <td valign="top">Password:</td>
            <td valign="top"><input name="password" type="password" id="password2" size="30"></td>
          </tr>
          <tr> 
            <td valign="top">confirm password:</td>
            <td valign="top"><input name="confirm_password" type="password" id="confirm_password" size="30"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td height="14" colspan="2" valign="top"><div align="center"></div></td>
          </tr>
        </table>
      </form></td>
  </tr>
